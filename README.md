...
### This Project or task is meant to demonstrate the use of Transfer Learning. I have used mobileNet pretrained model which is a very popular model for detection of 100+ objects. Here I have used to train it on images from http://www.anefian.com/research/face_reco.htm and the my images. The model trains on 12 images of 4 subjects and tests on 3 images each of these 4 subjects.Lets go ahesd and see how the code works.
